    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">{{ __('custom.add_manufacturer') }}</li>
            </ol>
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title">{{ __('custom.add_manufacturer') }}</h4>
                <form class="form-validate" action="{{ route('admin.manufacturers.store') }}" method="POST"
