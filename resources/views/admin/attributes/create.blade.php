    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">{{ __('custom.add_attribute') }}</li>
            </ol>
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title">{{ __('custom.add_attribute') }}</h4>
                <form class="form-validate" action="{{ route('admin.attributes.store') }}" method="POST"
