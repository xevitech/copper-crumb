...
<div class="page-title-box">
    <div class="row align-items-center">
        <div class="col-sm-6">
            <h4 class="page-title">{{ __t('sale_return_details') }}</h4>
        </div>
    </div>
</div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-12 d-print-none">
                        ...
                        <a class="btn btn-info float-right mr-2" href="{{ route('admin.sales-return.index') }}"><i
                       ...
                       <div class="col-sm-12">
                           <div class="table-responsive">
                               <table class="table table-bordered">
                                   ...
                                   <tbody>
                                   @foreach($sale_return->saleReturnItems as $key => $returnItems)
                                       <tr>
                                           <td>{{ $key+1 }}</td>
